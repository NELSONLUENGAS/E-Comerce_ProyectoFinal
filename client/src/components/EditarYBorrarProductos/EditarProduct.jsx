...
export default function EditarProduct({
    ...
    const handleDelete = (e, id, name)=>{
        e.preventDefault()
        var opcion = window.confirm("Estás Seguro que deseas Eliminar el Producto, "+name)
        if(opcion===true){
    ...
    return (<>
        ...
        <Card className={classes.conteiner}>
                ...
                <CardActions>
                   ...
                   <Button color="primary" onClick={HandleAdd} >Editar</Button>
                  
                <Button color="danger" onClick={(e) => handleDelete(e, id, name)}>Eliminar</Button>
