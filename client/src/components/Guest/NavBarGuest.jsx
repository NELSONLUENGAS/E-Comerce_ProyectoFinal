    ...
    <div  className="customerGrid">
      ...
      <div className="cusElement0">
        <div className='categories'>
          ...
          <div>
            <option onMouseOver={categoryFilter} onClick={handleSelect} value='Tecnologia'>Tecnología</option>
            <ArrowRightIcon/>
          </div>
          <div>
      ...
      <div className="modalLocation">
          ...
          </div>
        {
          ...
          <label>
              <input type="text" placeholder="Barrio(Opcinal)"/>
          </label>
          <label>
              <input type="text" placeholder="Dirrección"/>
          </label>
          <label>
              <input type="text" placeholder="Datos Adicionales(Opcinal)"/>
          </label>
        </div>
        }
        </div>
